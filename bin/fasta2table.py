...
parser.add_argument('-l', '--length-3pUTR', help="The maximum allowed length of a 3'UTR. (Default=20000).", type=int, default=20000, dest="utr3len", metavar="3'UTRLength")
...
# Concatenate the results of features calculations.
